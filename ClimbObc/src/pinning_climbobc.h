...
//	[PINIDX_I2C0_SCL] = { 0, 28, IOCON_MODE_INACT | IOCON_FUNC0, IOCON_DIR_OUTPUT, IOCON_OD_DISABLED, IOCON_VAL_HIGH },
	...
	[PINIDX_I2C_A_EN]	  	= { 0, 30, IOCON_MODE_INACT | IOCON_FUNC0, IOCON_DIR_OUTPUT, IOCON_OD_DISABLED, IOCON_VAL_HIGH },	// I2C(2) on A/X+ side High -> enabled
	[PINIDX_I2C_D_EN]	  	= { 1, 1,  IOCON_MODE_INACT | IOCON_FUNC0, IOCON_DIR_OUTPUT, IOCON_OD_DISABLED, IOCON_VAL_HIGH },   // I2C(0) on D/Y+ side High -> enabled
	[PINIDX_I2C_C_EN]	  	= { 1, 4,  IOCON_MODE_INACT | IOCON_FUNC0, IOCON_DIR_OUTPUT, IOCON_OD_DISABLED, IOCON_VAL_HIGH },   // I2C(0) on C/X- side High -> enabled
	...
	[PINIDX_I2C_B_EN]      	= { 2, 3,  IOCON_MODE_INACT | IOCON_FUNC0, IOCON_DIR_OUTPUT, IOCON_OD_DISABLED, IOCON_VAL_HIGH },   // high -> ENABLE I2C(2) on  B/Y- side
