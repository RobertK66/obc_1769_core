...
#include "lpc_types.h"				// common for all chips
#include "sys_config.h"				// this contains the chip define (CHIP_LPC175X_6X) only
#include "cmsis.h"					// this makes chipdependend further includes
...
#include <___chip_lpc177x_8x.h>

#elif defined(CHIP_LPC40XX)
#include <___chip_lpc407x_8x.h>
#endif
