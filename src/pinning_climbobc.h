...
static const PINMUX_GRP_T pinmuxing[] = {
	...
	//{ 0, P0_PIN_SPI_CS_SD,  IOCON_MODE_INACT | IOCON_FUNC0 }, 	/* SSL - CS  GPIO!	*/ // SPI only uses the SSL pin when in slave mode. To use as CS for Master this is normal IO
	...
	// GPIOs
	// Outputs
	{ 0, P0_PIN_SSP1_MRAM_CS2,	IOCON_MODE_INACT | IOCON_FUNC0},
	{ 0, P0_PIN_SPI_CS_SD,		IOCON_MODE_INACT | IOCON_FUNC0},
	{ 0, P0_PIN_SSP0_MRAM_CS1,	IOCON_MODE_INACT | IOCON_FUNC0},
	{ 0, P0_PIN_VCC_DISABLE,	IOCON_MODE_INACT | IOCON_FUNC0},
	{ 0, P0_PIN_I2C_A_EN,		IOCON_MODE_INACT | IOCON_FUNC0},
	{ 1, P1_PIN_I2C_D_EN,		IOCON_MODE_INACT | IOCON_FUNC0},
	{ 1, P1_PIN_I2C_C_EN,		IOCON_MODE_INACT | IOCON_FUNC0},
	{ 1, P1_PIN_CLR_WDT_FLIPFLOP,IOCON_MODE_INACT | IOCON_FUNC0},
	{ 1, P1_PIN_SSP1_MRAM_CS3,	IOCON_MODE_INACT | IOCON_FUNC0},
	{ 1, P1_PIN_SP3_VCC_EN,		IOCON_MODE_INACT | IOCON_FUNC0},
	{ 1, P1_PIN_WATCHDOG_FEED,	IOCON_MODE_INACT | IOCON_FUNC0},
	{ 1, P1_PIN_THRUSTER_CS_P,	IOCON_MODE_INACT | IOCON_FUNC0},
	{ 1, P1_PIN_SP4_VCC_EN,		IOCON_MODE_INACT | IOCON_FUNC0},
	{ 1, P1_PIN_SP1_VCC_EN,		IOCON_MODE_INACT | IOCON_FUNC0},
	{ 2, P2_PIN_SSP1_MRAM_CS1,	IOCON_MODE_INACT | IOCON_FUNC0},
	{ 2, P2_PIN_I2C_B_EN,		IOCON_MODE_INACT | IOCON_FUNC0},
	{ 2, P2_PIN_RS485_TX_RX,	IOCON_MODE_INACT | IOCON_FUNC0},
	{ 2, P2_PIN_LED,			IOCON_MODE_INACT | IOCON_FUNC0},
	{ 2, P2_PIN_SP2_VCC_EN,		IOCON_MODE_INACT | IOCON_FUNC0},
	{ 2, P2_PIN_SSP0_MRAM_CS2,	IOCON_MODE_INACT | IOCON_FUNC0},
	{ 2, P2_PIN_SSP0_MRAM_CS3,	IOCON_MODE_INACT | IOCON_FUNC0},
	{ 3, P3_PIN_SUPPLY_RAIL,	IOCON_MODE_INACT | IOCON_FUNC0},
	{ 4, P4_PIN_SD_VCC_EN,		IOCON_MODE_INACT | IOCON_FUNC0},

	// Inputs
	{ 0, P0_PIN_RBF,				IOCON_MODE_INACT | IOCON_FUNC0},
	{ 1, P1_PIN_THRUSTER_LATCHUP_P,	IOCON_MODE_INACT | IOCON_FUNC0},
	{ 2, P2_PIN_SP_VCC_FAULT,		IOCON_MODE_INACT | IOCON_FUNC0},
	{ 3, P3_PIN_BL_SEL1,			IOCON_MODE_INACT | IOCON_FUNC0},
	{ 4, P4_PIN_EXT_WDT_TRIGGERED,	IOCON_MODE_INACT | IOCON_FUNC0},

	// not decided yet. to measure correct connections to the outside lets make them outputs for now ....
	{ 0, P0_PIN_S_STACIE_IO1,	IOCON_MODE_INACT | IOCON_FUNC0},
	{ 1, P1_PIN_S_STACIE_IO2,	IOCON_MODE_INACT | IOCON_FUNC0},
	{ 1, P1_PIN_GPIO4_CP,		IOCON_MODE_INACT | IOCON_FUNC0},
	{ 1, P1_PIN_SPC_GPIO3_P,	IOCON_MODE_INACT | IOCON_FUNC0},
	{ 1, P1_PIN_STACIE_C_IO1_P,	IOCON_MODE_INACT | IOCON_FUNC0},
	{ 1, P1_PIN_STACIE_A_IO1_P,	IOCON_MODE_INACT | IOCON_FUNC0},
	{ 1, P1_PIN_STACIE_A_IO2_P,	IOCON_MODE_INACT | IOCON_FUNC0},
	{ 1, P1_PIN_GPIO3_A_P,		IOCON_MODE_INACT | IOCON_FUNC0},
	{ 1, P1_PIN_GPIO4_D_P,		IOCON_MODE_INACT | IOCON_FUNC0}

};

static const GPIO_INIT_T gpioinit[] = {
	{0, P0_PIN_SSP1_MRAM_CS2,	GPIO_DIR_OUTPUT, GPIO_VAL_HIGH	},
	{0, P0_PIN_SPI_CS_SD,		GPIO_DIR_OUTPUT, GPIO_VAL_HIGH	},
	{0, P0_PIN_SSP0_MRAM_CS1,	GPIO_DIR_OUTPUT, GPIO_VAL_HIGH	},
	{0, P0_PIN_VCC_DISABLE,		GPIO_DIR_OUTPUT, GPIO_VAL_HIGH	},
	{0, P0_PIN_I2C_A_EN,		GPIO_DIR_OUTPUT, GPIO_VAL_HIGH	},
	{1, P1_PIN_I2C_D_EN,		GPIO_DIR_OUTPUT, GPIO_VAL_HIGH	},
	{1, P1_PIN_I2C_C_EN,		GPIO_DIR_OUTPUT, GPIO_VAL_HIGH	},
	{1, P1_PIN_CLR_WDT_FLIPFLOP,GPIO_DIR_OUTPUT, GPIO_VAL_HIGH	},
	{1, P1_PIN_SSP1_MRAM_CS3,	GPIO_DIR_OUTPUT, GPIO_VAL_HIGH	},
	{1, P1_PIN_SP3_VCC_EN,		GPIO_DIR_OUTPUT, GPIO_VAL_HIGH	},
	{1, P1_PIN_WATCHDOG_FEED,	GPIO_DIR_OUTPUT, GPIO_VAL_HIGH	},
	{1, P1_PIN_THRUSTER_CS_P,	GPIO_DIR_OUTPUT, GPIO_VAL_HIGH	},
	{1, P1_PIN_SP4_VCC_EN,		GPIO_DIR_OUTPUT, GPIO_VAL_HIGH	},
	{1, P1_PIN_SP1_VCC_EN,		GPIO_DIR_OUTPUT, GPIO_VAL_HIGH	},
	{2, P2_PIN_SSP1_MRAM_CS1,	GPIO_DIR_OUTPUT, GPIO_VAL_HIGH	},
	{2, P2_PIN_I2C_B_EN,		GPIO_DIR_OUTPUT, GPIO_VAL_HIGH	},
	{2, P2_PIN_RS485_TX_RX,		GPIO_DIR_OUTPUT, GPIO_VAL_HIGH	},
	{2, P2_PIN_LED,				GPIO_DIR_OUTPUT, GPIO_VAL_HIGH	},
	{2, P2_PIN_SP2_VCC_EN,		GPIO_DIR_OUTPUT, GPIO_VAL_HIGH	},
	{2, P2_PIN_SSP0_MRAM_CS2,	GPIO_DIR_OUTPUT, GPIO_VAL_HIGH	},
	{2, P2_PIN_SSP0_MRAM_CS3,	GPIO_DIR_OUTPUT, GPIO_VAL_HIGH	},
	{3, P3_PIN_SUPPLY_RAIL,		GPIO_DIR_OUTPUT, GPIO_VAL_HIGH	},
	{4, P4_PIN_SD_VCC_EN,		GPIO_DIR_OUTPUT, GPIO_VAL_HIGH	},

	{ 0, P0_PIN_S_STACIE_IO1,	GPIO_DIR_OUTPUT, GPIO_VAL_HIGH	},
	{ 1, P1_PIN_S_STACIE_IO2,	GPIO_DIR_OUTPUT, GPIO_VAL_HIGH	},
	{ 1, P1_PIN_GPIO4_CP,		GPIO_DIR_OUTPUT, GPIO_VAL_HIGH	},
	{ 1, P1_PIN_SPC_GPIO3_P,	GPIO_DIR_OUTPUT, GPIO_VAL_HIGH	},
	{ 1, P1_PIN_STACIE_C_IO1_P,	GPIO_DIR_OUTPUT, GPIO_VAL_HIGH	},
	{ 1, P1_PIN_STACIE_A_IO1_P,	GPIO_DIR_OUTPUT, GPIO_VAL_HIGH	},
	{ 1, P1_PIN_STACIE_A_IO2_P,	GPIO_DIR_OUTPUT, GPIO_VAL_HIGH	},
	{ 1, P1_PIN_GPIO3_A_P,		GPIO_DIR_OUTPUT, GPIO_VAL_HIGH	},
	{ 1, P1_PIN_GPIO4_D_P,		GPIO_DIR_OUTPUT, GPIO_VAL_HIGH	},

	{ 0, P0_PIN_RBF,				GPIO_DIR_INPUT, GPIO_VAL_HIGH},
	{ 1, P1_PIN_THRUSTER_LATCHUP_P,	GPIO_DIR_INPUT, GPIO_VAL_HIGH},
	{ 2, P2_PIN_SP_VCC_FAULT,		GPIO_DIR_INPUT, GPIO_VAL_HIGH},
	{ 3, P3_PIN_BL_SEL1,			GPIO_DIR_INPUT, GPIO_VAL_HIGH},
	{ 4, P4_PIN_EXT_WDT_TRIGGERED,	GPIO_DIR_INPUT, GPIO_VAL_HIGH}
