...
static const PINMUX_GRP_T2 pinmuxing2[] = {
	...
	// 	3x I2C
	[PINIDX_I2C0_SDA] = { 0, 27, IOCON_MODE_INACT | IOCON_FUNC1},
	[PINIDX_I2C0_SCL] = { 0, 28, IOCON_MODE_INACT | IOCON_FUNC1},
	[PINIDX_I2C1_SDA] = { 0, 19, IOCON_MODE_INACT | IOCON_FUNC3},	/* FUNC2 is reserved! -> FUNC3 is I2C !!! */
	[PINIDX_I2C1_SCL] = { 0, 20, IOCON_MODE_INACT | IOCON_FUNC3},	/* FUNC2 is reserved! -> FUNC3 is I2C !!! */
	[PINIDX_I2C2_SDA] = { 0, 10, IOCON_MODE_INACT | IOCON_FUNC2},
	...
	[PINIDX_CLR_WDT_FLPFLP]	= { 1, 9,  IOCON_MODE_INACT | IOCON_FUNC0, IOCON_DIR_OUTPUT, IOCON_OD_DISABLED, IOCON_VAL_HIGH },
	...
	[PINIDX_I2C_B_EN]      	= { 2, 3,  IOCON_MODE_INACT | IOCON_FUNC0, IOCON_DIR_OUTPUT, IOCON_OD_DISABLED, IOCON_VAL_HIGH },
	[PINIDX_RS485_TX_RX]   	= { 2, 5,  IOCON_MODE_INACT | IOCON_FUNC0, IOCON_DIR_OUTPUT, IOCON_OD_DISABLED, IOCON_VAL_HIGH },
