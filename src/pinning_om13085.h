...
static const PINMUX_GRP_T pinmuxing[] = {
		...
		{ 0, P0_PIN_SSP0_SD_CS, IOCON_MODE_INACT | IOCON_FUNC0 }, 	/* SSL - CS  GPIO!	*/ // J2-13    SPI only uses the SSL pin when in slave mode. To use as CS for Master this is normal IO
		...
		{ 0, P0_PIN_SSP1_SD_CS, IOCON_MODE_INACT | IOCON_FUNC0 }, 	/* SSL  	        */  // J2-8 SSP1  SSL/CS GPIO controlled by SW.
		...
		// GPIOs
		{ 0, P0_PIN_LED_RED,       IOCON_MODE_INACT | IOCON_FUNC0 },	/* Led red       	*/
		{ 3, P3_PIN_LED_GREEN,     IOCON_MODE_INACT | IOCON_FUNC0 }, 	/* Led green     	*/
		{ 3, P3_PIN_LED_BLUE,      IOCON_MODE_INACT | IOCON_FUNC0 }, 	/* Led blue      	*/

		{ 0, P0_PIN_SSP1_MRAM_CS1, IOCON_MODE_INACT | IOCON_FUNC0 },	/* MRAM CS  SSP1-CS1 	*/ // J2-15
		{ 0, P0_PIN_SSP1_MRAM_CS2, IOCON_MODE_INACT | IOCON_FUNC0 }, 	/* MRAM CS  SSP1-CS2	*/ // J2-16
		{ 0, P0_PIN_SSP1_MRAM_CS3, IOCON_MODE_INACT | IOCON_FUNC0 }, 	/* MRAM CS  SSP1-CS3	*/ // J2-17
		{ 0, P0_PIN_SSP0_MRAM_CS1, IOCON_MODE_INACT | IOCON_FUNC0 }, 	/* MRAM CS  SSP0-CS1	*/ // J2-18
		{ 1, P1_PIN_SSP0_MRAM_CS2, IOCON_MODE_INACT | IOCON_FUNC0 }, 	/* MRAM CS  SSP0-CS2	*/ // J2-19
		{ 1, P1_PIN_SSP0_MRAM_CS3, IOCON_MODE_INACT | IOCON_FUNC0 }, 	/* MRAM CS  SSP0-CS3	*/ // J2-20

		// Use NC GPIO on J2-38 for debugging with scope.....
		{ 0, P0_PIN_NC1_SCOPE1,    IOCON_MODE_INACT | IOCON_FUNC0 } 	 /* P0[4]		    	 */ // J2-38
